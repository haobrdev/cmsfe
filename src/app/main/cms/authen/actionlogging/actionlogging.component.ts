...
@Component({
  selector: "cms-actionlogging",
  templateUrl: "./actionlogging.component.html",
  styleUrls: ["./actionlogging.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class ActionLoggingComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getListData = (): void => {
    ...
    if (this.search.search) {
      extraParams.push({
        field: "search",
        value: this.search.search.trim(),
      });
    }

    this._coreService.execute(state, "/logging/listAction", extraParams);
  };
  ...
  buildToolbar = () => {
    let toolbarList = [];
    this.toolbar = this.globals.buildToolbar("cms_authen_actionlogging", toolbarList);
  };
