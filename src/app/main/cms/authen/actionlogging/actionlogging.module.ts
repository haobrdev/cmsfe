...
import { ActionLoggingComponent } from './actionlogging.component';
...
const routes: Routes = [
  {
    path: '',
    component: ActionLoggingComponent
  }
];
