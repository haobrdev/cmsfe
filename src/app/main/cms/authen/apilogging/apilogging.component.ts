...
@Component({
  selector: "cms-apilogging",
  templateUrl: "./apilogging.component.html",
  styleUrls: ["./apilogging.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class APILoggingComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "/logging/listCallApi", extraParams);
  };
  ...
  buildToolbar = () => {
    let toolbarList = [];
    this.toolbar = this.globals.buildToolbar("cms_authen_apilogging", toolbarList);
  };
