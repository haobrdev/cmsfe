...
@Component({
  selector: "cms-configopensauto",
  templateUrl: "./configopensauto.component.html",
  styleUrls: ["./configopensauto.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class AppConfigOpensAutoComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  constructor(
    ...
    // Set language
    this.data = _configopensautoService;
  ...
  getListData = (): void => {
    ...
    this._configopensautoService.getlist(state, extraParams);
  };
  ...
  buildToolbar = () => {
    ...
    this.toolbar = this.globals.buildToolbar("cms_authen_configopensauto", toolbarList);

    let toolbarList2 = [];
    toolbarList2 = [ToolbarItem.EDIT, ToolbarItem.DELETE];
    this.toolbar2 = this.globals.buildToolbar("cms_authen_configopensauto", toolbarList2);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/authen/configopensauto/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate(["/cms/authen/configopensauto", paramAdd]);
        } else {
  ...
  confirmDeleteOne = (status): void => {
    if (status === "cancel") {
      ...
      if (this.modelDelete) {
        this._coreService.Post("/openingautomaticsetting/delete", {
  ...
  changeStatus = (data) => {
    setTimeout(() => {
      ...
      this._coreService.Post("/openingautomaticsetting/changeAcctive", {
        id: data.id,
