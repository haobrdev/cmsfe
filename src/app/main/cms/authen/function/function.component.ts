...
export class FunctionComponent implements OnInit {
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "/function/list", extraParams);
  };
  ...
  buildToolbar = () => {
    ...
    this.toolbar = this.globals.buildToolbar("cms_authen_function", toolbarList);


    let toolbarList2 = [];
    toolbarList2 = [ToolbarItem.EDIT, ToolbarItem.DELETE];
    this.toolbar2 = this.globals.buildToolbar("cms_authen_function", toolbarList2);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/authen/function/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate(["/cms/authen/function", paramAdd]);
        } else {
  ...
  confirmDeleteOne = (status): void => {
    if (status === "cancel") {
      ...
      if (this.modelDelete) {
        this._coreService.Post("/function/delete", {
  ...
  changeStatus = (data) => {
    setTimeout(() => {
      ...
      this._coreService.Post("/function/changeStatus", {
        id: data.id,
