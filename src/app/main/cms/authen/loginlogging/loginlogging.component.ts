...
@Component({
  selector: "cms-loginlogging",
  templateUrl: "./loginlogging.component.html",
  styleUrls: ["./loginlogging.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class LoginLoggingComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "/logging/listLogin", extraParams);
  };
  ...
  buildToolbar = () => {
    let toolbarList = [];
    this.toolbar = this.globals.buildToolbar("cms_authen_loginlogging", toolbarList);
  };
