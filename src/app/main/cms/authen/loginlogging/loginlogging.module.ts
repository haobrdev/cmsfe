...
import { LoginLoggingComponent } from './loginlogging.component';
...
const routes: Routes = [
  {
    path: '',
    component: LoginLoggingComponent
  }
];
