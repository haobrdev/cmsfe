...
import { OpeningautomaticcarComponent } from './openingautomaticcar.component';
...
const routes: Routes = [
  {
    path: '',
    component: OpeningautomaticcarComponent
  }
];
...
@NgModule({
  ...
  declarations: [OpeningautomaticcarComponent],
  providers: [CoreService, ToolbarService, ImageService, HtmlEditorService, TableService]
})
export class AppOpeningAutomaTicCarCarModule { }
