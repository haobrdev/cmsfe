import {
  ...
  export class CarComponent implements OnInit {
    ...
    getListData = (): void => {
      ...
      this._carService.getlist(state, extraParams);
    ...
    buildToolbar = () => {
      ...
      this.toolbar = this.globals.buildToolbar("cms_masterdata_car", toolbarList);
  
      
      let toolbarList2 = [];
      toolbarList2 = [ToolbarItem.EDIT, ToolbarItem.DELETE, ToolbarItem.VIEW];
      this.toolbar2 = this.globals.buildToolbar("cms_masterdata_car", toolbarList2);
    };
    ...
    clickToolbar = (itemButton: any): void => {
      ...
      switch (buttonId) {
        case ToolbarItem.ADD:
          this.router.navigate(["/cms/masterdata/car/new"]);
          break;
        case ToolbarItem.EDIT:
          ...
          if (selectRows && selectRows.length > 0) {
            ...
            this.router.navigate(["/cms/masterdata/car", paramAdd]);
          } else {
