import {
  ...
  export class ClientComponent implements OnInit {
    ...
    getListData = (): void => {
      ...
      if (this.search.checkpoint_name) {
        extraParams.push({
          ...
          value: this.search.checkpoint_name.trim(),
        });
      }
  
      this._clientService.getlist(state, extraParams);
    ...
    buildToolbar = () => {
      ...
      this.toolbar = this.globals.buildToolbar("cms_masterdata_checkpoints", toolbarList);
  
      
      let toolbarList2 = [];
      toolbarList2 = [ToolbarItem.EDIT, ToolbarItem.DELETE, ToolbarItem.VIEW];
      this.toolbar2 = this.globals.buildToolbar("cms_masterdata_checkpoints", toolbarList2);
    };
    ...
    clickToolbar = (itemButton: any): void => {
      ...
      switch (buttonId) {
        case ToolbarItem.ADD:
          this.router.navigate(["/cms/masterdata/client/new"]);
          break;
        case ToolbarItem.EDIT:
          ...
          if (selectRows && selectRows.length > 0) {
            ...
            this.router.navigate(["/cms/masterdata/client", paramAdd]);
          } else {
