...
@Component({
  selector: "cms-entryexitlane",
  templateUrl: "./entryexitlane.component.html",
  styleUrls: ["./entryexitlane.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class EntryExitLaneComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  buildToolbar = () => {
    ...
    this.toolbar = this.globals.buildToolbar("cms_masterdata_entryexitlane", toolbarList);
  ...
  getListData = (): void => {
    ...
    if (this.search.lane_name) {
      extraParams.push({
        field: "lane_name",
        value: this.search.lane_name,
      });
    }

    this._coreService.execute(state, "/entryexitlane/list", extraParams);
  };
  ...
  confirmDeleteOne = (status): void => {
    if (status === "cancel") {
      ...
      if (this.modelDelete) {
        this._coreService.Post("/entryexitlane/delete", {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/masterdata/entryexitlane/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate(["/cms/masterdata/entryexitlane", paramAdd]);
        } else {
