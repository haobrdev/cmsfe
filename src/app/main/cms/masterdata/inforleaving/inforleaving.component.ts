...
@Component({
  selector: "cms-inforleaving",
  templateUrl: "./inforleaving.component.html",
  styleUrls: ["./inforleaving.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class InforLeavingComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  buildToolbar = () => {
    ...
    this.toolbar = this.globals.buildToolbar("cms_masterdata_inforleaving", toolbarList);


    let toolbarList2 = [];
    toolbarList2 = [ToolbarItem.VIEW, ToolbarItem.EDIT, ToolbarItem.DELETE];
    this.toolbar2 = this.globals.buildToolbar("cms_masterdata_inforleaving", toolbarList2);
  };
  ...
  getListData = (): void => {
    ...
    if (this.search.document_number) {
      extraParams.push({
        field: "document_number",
        value: this.search.document_number
      });
    }
    ...
    this._coreService.execute(state, "/inforleaving/list", extraParams);
  };
  ...
  confirmDeleteOne = (status): void => {
    if (status === "cancel") {
      ...
      if (this.modelDelete) {
        this._coreService.Post("/inforleaving/delete", {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/masterdata/inforleaving/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate(["/cms/masterdata/inforleaving", paramAdd]);
        } else {
