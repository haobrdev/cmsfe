import {
  ...
  import { AccompanyingVehicle} from "src/app/_models/report/AccompanyingVehicle";
  ...
  @Component({
    selector: "app-accompanyingvehicle-edit",
    templateUrl: "./accompanyingvehicle-edit.component.html",
    styleUrls: ["./accompanyingvehicle-edit.component.scss"],
    providers: [FilterService, VirtualScrollService],
    encapsulation: ViewEncapsulation.None,
  })
  export class AccompanyingVehicleEditComponent implements OnInit {
    // Varriable Language
    flagState = "";
    model: AccompanyingVehicle = new AccompanyingVehicle();
    languages: any;
        ...
        [
          (cb) => {
            if (this.flagState != "new") {
              this._coreService
                .Get("/accompanyingvehicle/" + this.paramId)
                .subscribe((res) => {
                  if (res.code == "200") {
                    this.model = res.data;
                    cb();
      ...
      if (!this.editForm.valid) {
        ...
        const url =
          this.flagState && this.flagState === "new"
            ? "/accompanyingvehicle/create"
            : "/accompanyingvehicle/update";
        this._coreService.Post(url, modelRequest).subscribe(
          (res) => {
            if (res && res.code == "200") {
              this.notification.success("Cập nhật thành công!");
              this.router.navigate(["/cms/masterdata/accompanyingvehicle"]);
            } else {
