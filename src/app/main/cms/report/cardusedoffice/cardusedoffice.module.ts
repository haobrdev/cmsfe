...
import { CardusedofficeComponent } from './cardusedoffice.component';
...
const routes: Routes = [
  {
    path: '',
    component: CardusedofficeComponent
  }, 
];
