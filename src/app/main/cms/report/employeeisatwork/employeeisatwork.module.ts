...
import { EmployeeisatworkComponent } from './employeeisatwork.component';
...
const routes: Routes = [
  {
    path: '',
    component: EmployeeisatworkComponent
  }, 
];
