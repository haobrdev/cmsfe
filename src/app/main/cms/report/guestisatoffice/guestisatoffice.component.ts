import {
  ...
  @Component({
    selector: "cms-guestisatoffice",
    templateUrl: "./guestisatoffice.component.html",
    styleUrls: ["./guestisatoffice.component.scss"],
    providers: [FilterService, VirtualScrollService],
    encapsulation: ViewEncapsulation.None,
  })
    export class GuestisatofficeComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "/guestisatoffice/list", extraParams);
  };
  ...
  buildToolbar = () => {
    ...
    this.toolbar = this.globals.buildToolbar("cms_report_guestisatoffice", toolbarList);
    let toolbarList2 = [];
    toolbarList2 = [ToolbarItem.EDIT, ToolbarItem.DELETE];
    this.toolbar2 = this.globals.buildToolbar("cms_report_guestisatoffice", toolbarList2);
  };
  ...
  exportData = () => {
      let file_name =  "BÁO CÁO DANH SÁCH KHÁCH ĐANG Ở CƠ QUAN_" + moment().format('YYYYMMDDHHmmss');
      this._coreService.PostExport("/guestisatoffice/export", {
