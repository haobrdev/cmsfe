...
import { GuestisatofficeComponent } from './guestisatoffice.component';
...
const routes: Routes = [
  {
    path: '',
    component: GuestisatofficeComponent
  }, 
];
