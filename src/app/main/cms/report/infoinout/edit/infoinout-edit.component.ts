import {
  ...
  import { InfoInOut } from "src/app/_models/report/InfoInOut";
  ...
  @Component({
    selector: "app-infoinout-edit",
    templateUrl: "./infoinout-edit.component.html",
    styleUrls: ["./infoinout-edit.component.scss"],
    providers: [FilterService, VirtualScrollService],
    encapsulation: ViewEncapsulation.None,
  })
  export class InfoInOutEditComponent implements OnInit {
    // Varriable Language
    flagState = "";
        ...
        this._coreService.Post(url, modelRequest).subscribe(
          (res) => {
            if (res && res.code == "200") {
              ...
              this.router.navigate(["/cms/masterdata/infoinout"]);
            } else {
