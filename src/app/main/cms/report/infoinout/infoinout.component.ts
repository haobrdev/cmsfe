...
@Component({
    selector: "cms-infoinout",
    templateUrl: "./infoinout.component.html",
    styleUrls: ["./infoinout.component.scss"],
    providers: [FilterService, VirtualScrollService],
    encapsulation: ViewEncapsulation.None,
  })
  export class InfoInOutComponent implements OnInit {
// Varriable Language
languages: any;
...
getListData = (): void => {
  ...
  this._coreService.execute(state, "/infoinout/list", extraParams);
...
exportData = () => {
  ...
  if (!this.isError)
  {
    ...
    this._coreService.PostExport("/infoinout/export", {
